...
lightsensor_resume(struct platform_device *pdev)
{
	...
	rt = regulator_set_voltage(l9, 3000000, 3000000);
...
static void gp2a_work_func_light(struct work_struct *work)
{
	...
	if(adc >= 1900) { //(adc >= 1050)
		level_state = LIGHT_LEVEL5;
		buffering = 5;
	} else if(adc >= 1700 && adc < 1900) { //(adc >= 800 && adc < 1050)
		if(buffering == 5) {	
			level_state = LIGHT_LEVEL5;
			buffering = 5;
	...
	} else if(adc >= 1600 && adc < 1700) { //(adc >= 750 && adc < 800)
		level_state = LIGHT_LEVEL4;
		buffering = 4;
	} else if(adc >= 1000 && adc < 1600) { //(adc >= 560 && adc < 750)
	...
	} else if(adc >= 700 && adc < 1000) { //(adc >= 550 && adc < 560)
		level_state = LIGHT_LEVEL3;
		buffering = 3;
	} else if(adc >= 500 && adc < 700) { //(adc >= 370 && adc < 550)
	...
	} else if(adc >= 320 && adc < 500) { //(adc >= 270 && adc < 370)
		level_state = LIGHT_LEVEL2;
		buffering = 2;
	} else if(adc >= 230 && adc < 320) { //(adc >= 200 && adc < 270)
