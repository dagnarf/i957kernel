...
/* timing */ 
{0xA9, 0x8A, 0x17, 0x00, 0x4C, 0x90, 0x1A, 0x8C, 
0x19, 0x03, 0x04}, 
{0x7f, 0x00, 0x00, 0x00},	/* phy ctrl */ 
{0xee, 0x03, 0x86, 0x03},	/* strength */ 
{0x41, 0x72, 0x01, 0x1A, 0x00, 0x50, 0x48, 0x63, 
...
///{0x03, 0x01, 0x01, 0x00},	// LDO regulator
//{0xB0, 0x8C, 0x1A, 0x00, 0x19, 0x92, 0x1E, 0x8E, 0x19, 0x03, 0x04}, // timing 
//{0x7f, 0x00, 0x00, 0x00},	// phy ctrl 
//{0xee, 0x03, 0x86, 0x03},	// strength 
//{0x41, 0xE9, 0x31, 0xDA, 0x00, 0x50, 0x48, 0x63, 0x31, 0x0F, 0x03,// 4 lane  
//0x05, 0x14, 0x03, 0x03, 0x03, 0x54, 0x06, 0x10, 0x04, 0x03 }, 
#endif
}; 
static int __init mipi_video_s6e8ab0_wxga_pt_init(void)
{
	...
	pinfo.lcdc.v_front_porch = 13; // 13; 
	pinfo.lcdc.v_pulse_width = 2; //2; 

	pinfo.lcdc.border_clr = 0; /* blk */ 
	pinfo.lcdc.underflow_clr = 0; /* red */ 
