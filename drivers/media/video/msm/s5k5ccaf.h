...
#define CAM_DEBUG(fmt, arg...)	\
		do {\
			printk("\033[[s5k5ccaf] %s:%d: " fmt "\033[0m\n", __FUNCTION__, __LINE__, ##arg);}\
		while(0)
...
#define S5K5CCGX_EFFECT_OFF		0
#define S5K5CCGX_EFFECT_NEGATIVE	2
#define S5K5CCGX_EFFECT_MONO		1
#define S5K5CCGX_EFFECT_SEPIA		4


#define S5K5CCGX_WB_AUTO		1
#define S5K5CCGX_WB_DAYLIGHT		5
#define S5K5CCGX_WB_CLOUDY		6
#define S5K5CCGX_WB_FLUORESCENT		4
#define S5K5CCGX_WB_INCANDESCENT	3



/* Brightness */
#define S5K5CCGX_BR_MINUS_4		0
#define S5K5CCGX_BR_MINUS_3		1
#define S5K5CCGX_BR_MINUS_2		2
#define S5K5CCGX_BR_MINUS_1		3
#define S5K5CCGX_BR_DEFAULT		4
#define S5K5CCGX_BR_PLUS_1		5
#define S5K5CCGX_BR_PLUS_2		6
#define S5K5CCGX_BR_PLUS_3		7
#define S5K5CCGX_BR_PLUS_4		8
...
#define	S5K5CCGX_ISO_AUTO		0
#define	S5K5CCGX_ISO_50			1
#define	S5K5CCGX_ISO_100		2
#define	S5K5CCGX_ISO_200		3
#define	S5K5CCGX_ISO_400		4


#define S5K5CCGX_METERING_NORMAL	0 //CENTER?
#define S5K5CCGX_METERING_CENTER	1
#define S5K5CCGX_METERING_SPOT		2



#define S5K5CCGX_SCENE_OFF		0
#define S5K5CCGX_SCENE_LANDSCAPE	1
#define S5K5CCGX_SCENE_BEACH		3
#define S5K5CCGX_SCENE_SUNSET		4
#define S5K5CCGX_SCENE_NIGHTSHOT	5
#define S5K5CCGX_SCENE_PORTRAIT		6
#define S5K5CCGX_SCENE_BACKLIGHT	7
#define S5K5CCGX_SCENE_SPORTS		8
#define S5K5CCGX_SCENE_CANDLE		11
#define S5K5CCGX_SCENE_FIREWORK		12
#define S5K5CCGX_SCENE_PARTY		13
#define S5K5CCGX_SCENE_DAWN		15	// added for Samsung
#define S5K5CCGX_SCENE_FALL		16	// added for Samsung
#define S5K5CCGX_SCENE_TEXT		17	// added for Samsung
