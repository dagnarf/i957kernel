...
#define MSM_DMOV_ADM0_BASE	IOMEM(0xFD400000)
#define MSM_DMOV_ADM0_PHYS	0x18320000
#define MSM_DMOV_ADM0_SIZE	SZ_1M

#define MSM_DMOV_ADM1_BASE	IOMEM(0xFD500000)
...
#define MSM_MPM_BASE	IOMEM(0xFEC41000)
#define MSM_MPM_PHYS	0x00200000
#define MSM_MPM_SIZE	SZ_4K
