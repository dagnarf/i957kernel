...
#if defined(CONFIG_TARGET_LOCALE_KOR_SKT) ||defined(CONFIG_TARGET_LOCALE_KOR_LGU)||defined(CONFIG_TARGET_LOCALE_KOR_KT)
...
#if !(defined (CONFIG_MACH_P8_LTE) || defined (CONFIG_MACH_P5_LTE) || defined (CONFIG_MACH_P4_LTE))
...
#if 0 //!(defined (CONFIG_MACH_P5_LTE) || defined (CONFIG_MACH_P4_LTE))
	{
		.gpio      = 153,
		.settings = {
...
#endif
#if 0 // GPIO 157 is CMC623 I2C SCL pin
	{
		.gpio      = 157,
		.settings = {
...
#if ((defined (CONFIG_TARGET_LOCALE_USA_ATT) || defined (CONFIG_TARGET_LOCALE_EUR)) && defined (CONFIG_MACH_P5_LTE)) || defined (CONFIG_MACH_P8_LTE)
	{
		.gpio      = 102,
		.settings = {
...
#elif defined (CONFIG_TARGET_LOCALE_KOR_SKT) || defined (CONFIG_TARGET_LOCALE_KOR_LGU) || defined (CONFIG_TARGET_LOCALE_KOR_KT)
	{
		.gpio	   = 102,
		.settings = {
...
#if !(((defined (CONFIG_TARGET_LOCALE_USA_ATT) || defined(CONFIG_TARGET_LOCALE_EUR)) && defined (CONFIG_MACH_P5_LTE)) \
	|| defined(CONFIG_TARGET_LOCALE_KOR_SKT) || defined(CONFIG_TARGET_LOCALE_KOR_LGU) || defined(CONFIG_TARGET_LOCALE_KOR_KT) \
	|| defined (CONFIG_MACH_P4_LTE) || defined (CONFIG_MACH_P8_LTE))
	/* MI2S SCLK */
	{
		.gpio = 102,
		.settings = {
...
#if !(defined(CONFIG_MACH_P8_LTE) || defined(CONFIG_MACH_P5_LTE) || defined(CONFIG_MACH_P4_LTE)) // for SAMSUNG setting
...
struct msm_gpiomux_configs
msm8x60_p4_lte_gpiomux_cfgs[] __initdata = {
	{msm8x60_gsbi_configs, ARRAY_SIZE(msm8x60_gsbi_configs)},
	{p5_lte_usb_sel, ARRAY_SIZE(p5_lte_usb_sel)}, 
	{msm8x60_uart_configs, ARRAY_SIZE(msm8x60_uart_configs)},
#ifdef CONFIG_MSM_GSBI9_UART
...
//	{msm8x60_common_configs, ARRAY_SIZE(msm8x60_common_configs)},
	...
	{msm8x60_wlan_configs, ARRAY_SIZE(msm8x60_wlan_configs)},
	{msm8x60_motor_configs, ARRAY_SIZE(msm8x60_motor_configs)},
	{msm8x60_accessory_configs, ARRAY_SIZE(msm8x60_accessory_configs)},
	{msm8x60_boot_configs, ARRAY_SIZE(msm8x60_boot_configs)},
       	{msm8x60_nc_configs, ARRAY_SIZE(msm8x60_nc_configs)},
