...
static DEVICE_ATTR(uart_sel, S_IRUGO | S_IWUGO, uart_sel_show, uart_sel_store);
static DEVICE_ATTR(usb_sel, S_IRUGO | S_IWUGO, usb_sel_show, usb_sel_store);
static DEVICE_ATTR(usb_state, S_IRUGO | S_IWUGO, usb_state_show, usb_state_store);
static DEVICE_ATTR(disable_vbus, S_IRUGO |S_IWUGO, disable_vbus_show, disable_vbus_store);
#ifdef _SEC_DM_
static DEVICE_ATTR(enable, S_IRUGO | S_IWUGO | S_IRUSR | S_IWUSR, usb_lock_enable_show, usb_lock_enable_store);
#endif
