...
#define IS_SWITCH(id)	((id >= RPM_VREG_ID_PM8058_LVS0 && \
			 ...
			 (id == RPM_VREG_ID_PM8901_USB_OTG) || \
			 (id == RPM_VREG_ID_PM8901_HDMI_MVS) )
...
static struct regulator_desc vreg_descrip[RPM_VREG_ID_MAX] = {
	...
	DESC(RPM_VREG_ID_PM8901_USB_OTG, "8901_hvs0", &switch_ops),
	DESC(RPM_VREG_ID_PM8901_HDMI_MVS, "8901_hdmi_mvs", &switch_ops),
};
